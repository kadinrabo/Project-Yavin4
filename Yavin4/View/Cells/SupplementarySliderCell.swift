...
class SupplementarySliderCell: UICollectionViewCell, ConfigurableCell {
    
    static let reuseIdentifier: String = "SupplementarySliderCell"
    let title = UILabel()
    ...
    override init(frame: CGRect) {
        ...
        let stackView = UIStackView(arrangedSubviews: [title, subtitle, imageView])  // separator
